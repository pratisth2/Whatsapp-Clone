    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                progressDialog.show();
                auth.createUserWithEmailAndPassword(binding.edEmail.getText().toString(), binding.edPassword.getText().toString()).
                        addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    databse.getReference().child("Users").child(id).setValue(user);
        ...
        binding.edAc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
